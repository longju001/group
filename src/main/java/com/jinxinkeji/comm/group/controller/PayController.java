...
import com.jinxinkeji.comm.group.util.PayUtil;
import com.jinxinkeji.comm.group.util.UUIDHexGenerator;
import com.jinxinkeji.comm.group.util.XmlUtil;
...
@RestController
@RequestMapping("/serv")
@Api(value = "支付", tags = "支付相关的接口", description = "支付相关的接口")
public class PayController {
    ...
    @ResponseBody
    public JSONObject payment(@RequestParam(required = true) String openId,
                              @RequestParam(required = true)String total_fee,
                              @RequestParam(required = false) String body,
                              @RequestParam(required = false) String attach) throws UnsupportedEncodingException, DocumentException {
    ...
    public void paycallback(HttpServletRequest request) {
        try {
            ...
            // "bank_type":"CFT","openid":"oXI6G5Jc4D44y2wixgxE3OPwpDVg","sign":"262978D36A3093ACBE4B55707D6EA7B2",
            // "fee_type":"CNY","mch_id":"1491307962","cash_fee":"10","out_trade_no":"14913079622018052909183048768217",
            // "appid":"wxa177427bc0e60aab","total_fee":"10","trade_type":"JSAPI","result_code":"SUCCESS",
            // "time_end":"20180529091834","is_subscribe":"N","return_code":"SUCCESS"}
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
